...
@Composable
fun NoostakFloatingActionButtonWithText(
    title: String,
...
@Composable
fun NoostakFloatingActionButtonWithTextPreview() {
    NoostakAndroidTheme {
        NoostakFloatingActionButtonWithText(title = "추가", modifier = Modifier, onClick = {})
    }
}
